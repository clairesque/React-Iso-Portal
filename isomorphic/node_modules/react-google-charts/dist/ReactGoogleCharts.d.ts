...
import { ReactGoogleChartProps, ReactGoogleChartState } from "./types";
export declare class Chart extends React.Component<ReactGoogleChartProps, ReactGoogleChartState> {
    state: {
        ...
        google: import("./types").GoogleViz | null;
    };
    static defaultProps: {
        ...
        getChartWrapper: (chartWrapper: import("./types").GoogleChartWrapper, google: import("./types").GoogleViz) => void;
        getChartEditor: ((args: {
            chartEditor: import("./types").GoogleChartEditor;
            chartWrapper: import("./types").GoogleChartWrapper;
            google: import("./types").GoogleViz;
        }) => void) | null;
        className: string;
        style: {};
        formatters: null;
